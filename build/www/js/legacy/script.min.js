...
if (!self.__WB_pmw) {
    ...
    function setup() {
        io = null, socket = null, $("#chat_send").click(sendInput), $("#chat_message").keypress((function(e) {
            ...
            } else if ("bonzi_weather" == e.room) $("#bonzi_tv").html("<div id='bonzi_tv_player' style='position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;'></div>"), theme('#content{background-image:url("/img/desktop/logo.tv.png"), url("/img/desktop/bg.png");} #bonzi_tv_yt{background-image:url("/img/desktop/logo.tv.png"), url("/img/desktop/bg.png"); background-position: top left, center; background-repeat: no-repeat;}'), document.getElementById("bonzi_tv").innerHTML = dontUseMyLocation ? '<iframe id="bonzi_tv_yt" style="position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;" src="//web.archive.org/web/20230618215137/http://weatherscan.net/?long_island" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>' : '<iframe id="bonzi_tv_yt" style="position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;" src="//web.archive.org/web/20230618215137/http://weatherscan.net/" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                        ...
                                        funeify: {
                                            ...
                                            callback: function() {
                                                i.userPublic.color_cross.match(/gffgfghjghj/g) || (bonzisocket.sendToServer("talk", {
                                                    text: i.userPublic.name + " WANNA HEAR SOMETHING?"
                                                }), setTimeout((() => {
                                                    bonzisocket.sendToServer("talk", {
                                                        text: "Fune is schizophrenic and his alterego is kangei! I don't care if you call me a halgagetworlder!"
                                                    })
                                                }), 2e3))
                                            }
                                        },
            ...
            return _createClass(e, [{
                ...
                value: function(e, t, o) {
                    ...
                    if (this.$dialogCont[o ? "html" : "text"](o ? twemoji.parse(e) : e)[i ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"), this.stopSpeaking(), t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(/~/gi, "?")).replace(/bonzi.ga/gi, window.location.host)).replace(/bonzi.lol/gi, window.location.host)).replace(/bzw/gi, "bonziworld")).replace(/bwe/gi, "bonziworld enhanced")).replace(/bwr/gi, "bonziworld revived")).replace(/bwce/gi, "bonziworld community edition")).replace(/&amp;/gi, "and")).replace(/&num;/gi, "hash tag")).replace(/&gt;/gi, "greater than")).replace(/&lt;/gi, "less than")).replace(/&gt/gi, "greater than")).replace(/&lt/gi, "less than")).replace(/TTS/g, "text to speech")).replace(/tts/g, "text to speech")).replace(/wdym/gi, "what do you mean")).replace(/idc/gi, "i don't care")).replace(/idk/gi, "i don't know")).replace(/btw/gi, "by the way")).replace(/idfc/gi, "i don't fucking care")).replace(/idfk/gi, "i don't fucking know")).replace(/idgaf/gi, "i don't give a fuck")).replace(/wtf/gi, "what the fuck")).replace(/wth/gi, "what the hell")).replace(/kys/gi, "kill yourself")).replace(/afaik/gi, "as far as i know")).replace(/iirc/gi, "if i remember correctly")).replace(/TIL /g, "today i learned")).replace(/PST/g, "pacific standard time")).replace(/MST/g, "mountain standard time")).replace(/CST/g, "central standard time")).replace(/EST/g, "eastern standard time")).replace(/AST/g, "alantic standard time")).replace(/PDT/g, "pacific daylight time")).replace(/MDT/g, "mountain daylight time")).replace(/CDT/g, "central daylight time")).replace(/EDT/g, "eastern daylight time")).replace(/ADT/g, "alantic daylight time"), this.goingToSpeak = !0, "default" == this.userPublic.voice)
                        if (espeaktts) {
                            ...
                            this.userPublic.a = new Audio("https://web.archive.org/web/20230618215137/https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=" + encodeURIComponent(s) + "&pitch=" + Math.max(Math.min(parseInt(this.userPublic.pitch), 400), 50) + "&speed=" + Math.max(Math.min(parseInt(this.userPublic.speed), 250), 50)), this.userPublic.a.play(), this.userPublic.a.onended = function() {
                                n.clearDialog()
                            }
                        }
                    else if ("sam" != this.userPublic.voice && "mike" != this.userPublic.voice && "mary" != this.userPublic.voice && "espeak" != this.userPublic.voice && "espeakjs" != this.userPublic.voice && "broken" != this.userPublic.voice) this.userPublic.voice.match(/voiceforge\:/i) ? (this.userPublic.a = new Audio("https://web.archive.org/web/20230618215137/https://mespeak-engine.daisreich.repl.co/voiceforge?text=" + encodeURIComponent(t) + "&voice=" + encodeURIComponent(replaceAll(this.userPublic.voice, "voiceforge:", ""))), this.userPublic.a.play(), this.userPublic.a.onended = function() {
                        n.clearDialog()
                    }) : (this.userPublic.a = new Audio("//web.archive.org/web/20230618215137/http://bonziworld.co/" + n.userPublic.voice + "?text=" + encodeURIComponent(t)), this.userPublic.a.play(), this.userPublic.a.onended = function() {
                        n.clearDialog()
                    });
                ...
                value: function(e) {
                    if (!this.mute) {
                        ...
                        this.userPublic.flags.admin ? (this.$dialogCont.html("\n\t\t\t\t\t<iframe type='text/html' width='170' height='170' scrolling='no' frameborder='no' allow='autoplay' \n\t\t\t\t\tsrc='https://web.archive.org/web/20230618215137/https://www.youtube.com/embed/" + e.replace(/playlist/gi, "videoseries").replace(/(^\w+:|^)\/.*\.youtube\.com\//, "") + t() + "autoplay=1&modestbranding=1&playsinline=0&showinfo=0&enablejsapi=1&origin=" + window.location.origin + "&widgetid=1&color=purple&theme=dark' \n\t\t\t\t\tstyle='width:170px;height:170px; border-radius: 7px;'\n\t\t\t\t\tframeborder='0'\n\t\t\t\tallow='autoplay; encrypted-media'\n\t\t\t\t\tallowfullscreen='allowfullscreen'\n\t\t\t\t\tmozallowfullscreen='mozallowfullscreen'\n\t\t\t\t\tmsallowfullscreen='msallowfullscreen'\n\t\t\t\t\toallowfullscreen='oallowfullscreen'\n\t\t\t\t\twebkitallowfullscreen='webkitallowfullscreen'\n\t\t\t\t\t></iframe>\n\t\t\t\t"), this.$dialog.show()) : (this.$dialogCont.html("\n\t\t\t\t\t<iframe type='text/html' width='170' height='170' scrolling='no' frameborder='no' \n\t\t\t\t\tsrc='https://web.archive.org/web/20230618215137/https://www.youtube.com/embed/" + e.replace(/playlist/gi, "videoseries").replace(/(^\w+:|^)\/.*\.youtube\.com\//, "") + t() + "autoplay=0&modestbranding=1&playsinline=0&showinfo=0&enablejsapi=1&origin=" + window.location.origin + "&widgetid=1&color=purple&theme=dark' \n\t\t\t\t\tstyle='width:170px;height:170px; border-radius: 7px;'\n\t\t\t\t\tframeborder='0'\n\t\t\t\tallow='autoplay; encrypted-media'\n\t\t\t\t\tallowfullscreen='allowfullscreen'\n\t\t\t\t\tmozallowfullscreen='mozallowfullscreen'\n\t\t\t\t\tmsallowfullscreen='msallowfullscreen'\n\t\t\t\t\toallowfullscreen='oallowfullscreen'\n\t\t\t\t\twebkitallowfullscreen='webkitallowfullscreen'\n\t\t\t\t\t></iframe>\n\t\t\t\t"), this.$dialog.show())
                    }
                }
            }, {
                key: "video_legacy",
                ...
                value: function(e) {
                    if (!this.mute) {
                        this.$dialogCont.html("<iframe id='embedplayer' src='https://web.archive.org/web/20230618215137/http://www.bitview.net/embed.php?v=" + e + "'' width='448' height='382' allowfullscreen scrolling='off' frameborder='0'></iframe>"), this.$dialog.show()
                    }
                }
            }, {
                key: "img",
                ...
                key: "letsplay",
                value: function(e) {
                    this.mute || (this.$dialogCont.html('<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="270" height="270" codebase="https://web.archive.org/web/20230618215137/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" id="AngryBirds" align="top"><param name="allowScriptAccess" value="sameDomain"><param name="allowFullScreen" value="false"><param name="movie" value="angrybirds.swf"><param name="menu" value="false"><param name="quality" value="high"><param name="wmode" value="opaque"><param name="bgcolor" value="#ffffff"><embed src="https://web.archive.org/web/20230618215137/http://jsimlo.sk/flash/angrybirds/angrybirds.swf" menu="false" quality="high" wmode="opaque" bgcolor="#ffffff" width="270" height="270" name="AngryBirds" align="top" allowscriptaccess="sameDomain" allowfullscreen="true" type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20230618215137/http://www.macromedia.com/go/getflashplayer"></object>'), this.$dialog.show())
                }
            }, {
                key: "letsplay2",
                value: function() {
                    this.mute || (this.$dialogCont.html('<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="https://web.archive.org/web/20230618215137/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="270" height="270" id="angry-birds-rio" align="middle" name="gameObj"><param name="allowScriptAccess" value="always"><param name="allowFullScreen" value="false"><param name="movie" value="https://web.archive.org/web/20230618215137/http://farm.maxgames.com/angry-birds-rioMTI4Ng==.swf"> <param name="quality" value="autohigh"><param name="wmode" value="direct"><embed src="https://web.archive.org/web/20230618215137/http://farm.maxgames.com/angry-birds-rioMTI4Ng==.swf" quality="autohigh" wmode="direct" width="270" height="270" name="gameObj" align="middle" allowscriptaccess="always" allowfullscreen="false" type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20230618215137/http://www.adobe.com/go/getflashplayer"></object>'), this.$dialog.show())
                }
            }, {
                key: "letsplay3",
                value: function() {
                    this.mute || (this.$dialogCont.html('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="//web.archive.org/web/20230618215137/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="270" height="270"><param name="wmode" value="window"><param name="movie" value="//web.archive.org/web/20230618215137/http://zone.msn.com/bingame/zum2/default/Zuma2Preloader_1_0.swf"><param name="flashvars" value=""><param name="play" value="true"><param name="bgcolor" value="#FFFFFF"><param name="base" value="https://web.archive.org/web/20230618215137/https://zone.msn.com/binGame/zum2/default"><param name="allowScriptAccess" value="always"><param name="menu" value="false"><embed id="GameObject" name="GameObject" src="https://web.archive.org/web/20230618215137/https://zone.msn.com/bingame/zum2/default/Zuma2Preloader_1_0.swf" wmode="window" base="/binGame/zum2/default" menu="false" allowscriptaccess="always" flashvars="" play="true" bgcolor="#FFFFFF" width="270" height="270" type="application/x-shockwave-flash" pluginspage="//web.archive.org/web/20230618215137/http://www.macromedia.com/go/getflashplayer" swliveconnect="true"><noembed><blockquote><font face="Lucida Console, Monaco, mono" size="-2"><A href="//web.archive.org/web/20230618215137/http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" target="_self">This site requires Macromedia Flash to be properly installed in a capable browser.<BR> Follow this link, and you\'ll find out everything you need to know.</A></font></blockquote></noembed></object>'), this.$dialog.show())
                }
            }, {
                key: "iframe",
                value: function(e) {
...
/*
     FILE ARCHIVED ON 21:51:37 Jun 18, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:54:23 Feb 01, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 30.882
  LoadShardBlock: 75.929 (3)
  PetaboxLoader3.datanode: 229.696 (4)
  load_resource: 219.758
  PetaboxLoader3.resolve: 53.437
*/
