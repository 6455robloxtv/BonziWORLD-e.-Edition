...
function execute() {
    $("#evaljs_console").append("\n> " + $("#evaljs_codebox").val()), socket.emit("evaljs", {
        input: $("#evaljs_codebox").val()
    })
}
...
interact(".win2000_base").draggable({
...
function loadBonzis(a) {
    loadQueue.loadManifest([{
        id: "bonziBlack",
        src: "./img/bonzi/black.gif"
    }, {
        id: "bonziBlue",
        src: "./img/bonzi/blue.gif"
    }, {
        id: "bonziBrown",
        src: "./img/bonzi/brown.gif"
    }, {
        id: "bright_blue",
        src: "./img/bonzi/bright_blue.gif"
    }, {
        id: "bright_brown",
        src: "./img/bonzi/bright_brown.gif"
    }, {
        id: "bonziPeedy",
        src: "./img/bonzi/peedy.gif"
    }, {
        id: "robby",
        src: "./img/bonzi/robby.gif"
    }, {
        id: "bonziMax",
        src: "./img/bonzi/max.gif"
    }, {
        id: "bonziGreen",
        src: "./img/bonzi/green.gif"
    }, {
        id: "bright_green",
        src: "./img/bonzi/bright_green.gif"
    }, {
        id: "owner",
        src: "./img/bonzi/owner.gif"
    }, {
        id: "bonziPurple",
        src: "./img/bonzi/purple.gif"
    }, {
        id: "bonziCyan",
        src: "./img/bonzi/cyan.gif"
    }, {
        id: "bright_purple",
        src: "./img/bonzi/bright_purple.gif"
    }, {
        id: "bright_cyan",
        src: "./img/bonzi/bright_cyan.gif"
    }, {
        id: "clippy",
        src: "./img/bonzi/clippy.gif"
    }, {
        id: "merlin",
        src: "./img/bonzi/merlin.gif"
    }, {
        id: "genie",
        src: "./img/bonzi/genie.gif"
    }, {
        id: "clippypope",
        src: "./img/bonzi/clippypope.gif"
    }, {
        id: "bruh",
        src: "./img/bonzi/bruh.gif"
    }, {
        id: "robot",
        src: "./img/bonzi/robot.gif"
    }, {
        id: "diogo",
        src: "./img/bonzi/diogo.gif"
    }, {
        id: "soldier",
        src: "./img/bonzi/soldier.gif"
    }, {
        id: "diogo2",
        src: "./img/bonzi/diogo2.gif"
    }, {
        id: "program",
        src: "./img/bonzi/program.gif"
    }, {
        id: "dogpope",
        src: "./img/bonzi/dogpope.gif"
    }, {
        id: "god",
        src: "./img/bonzi/god.gif"
    }, {
        id: "redclippy",
        src: "./img/bonzi/red_clippy.gif"
    }, {
        id: "rover",
        src: "./img/bonzi/rover.gif"
    }, {
        id: "bonziGrey",
        src: "./img/bonzi/grey.gif"
    }, {
        id: "bonziRed",
        src: "./img/bonzi/red.gif"
    }, {
        id: "bright_red",
        src: "./img/bonzi/bright_red.gif"
    }, {
        id: "bonziPink",
        src: "./img/bonzi/pink.gif"
    }, {
        id: "bonziYellow",
        src: "./img/bonzi/yellow.gif"
    }, {
        id: "bright_yellow",
        src: "./img/bonzi/yellow.gif"
    }, {
        ...
        id: "bonziDunce",
        src: "./img/bonzi/dunce.gif"
    }, {
        id: "kiddie",
        src: "./img/bonzi/shitsky.gif"
    }, {
        id: "bonziOrange",
        src: "./img/bonzi/orange.gif"
    }, {
        id: "bonziWhite",
        src: "./img/bonzi/white.gif"
    }, {
        id: "bonziDarkPurple",
        src: "./img/bonzi/dark_purple.gif"
    }, {
        id: "bonziGlitch",
        src: "./img/bonzi/glitch.gif"
    }, {
        id: "bonziRainbow",
        src: "./img/bonzi/rainbow.gif"
    }, {
        id: "bonziAux",
        src: "./img/bonzi/glitchy.gif"
    }, {
        id: "bonziNul",
        src: "./img/bonzi/buggiest.gif"
    }, {
        id: "topjej",
        ...
        id: "error",
        src: "error.ogg"
    }]), loadQueue.on("fileload", function(a) {
        loadDone.push(a.item.id)
    }, this), a && loadQueue.on("complete", a, this)
}

function loadTest() {
    $("#login_card").hide(), $("#login_error").hide(), $("#login_load").show(), document.getElementById("page_login").style.cursor = "wait", window.loadTestInterval = rInterval(function() {
        try {
...
function setup() {
    $("#chat_send").click(sendInput), $("#chat_message").keypress(function(a) {
        13 == a.which && sendInput()
    }), socket.on("room", function(a) {
        document.getElementById("content").style.backgroundColor = a.background, $("#room_owner")[a.isOwner ? "show" : "hide"](), $("#room_public")[a.isPublic ? "show" : "hide"](), $("#room_private")[a.isPublic ? "hide" : "show"](), $("#room_id").text(a.room)
        ...
        setTimeout(function() {
            if (b.color == "diogo") {
                ...
                aud.play()
            } else if (b.color == "losky") {
                var aud = new Audio("losky_surfgone.ogg");
                aud.play()
                ...
                var aud = new Audio("bye.wav");
                aud.play()
            }
        }, 600);
        "undefined" != typeof b && b.exit(function(a) {
...
var _createClass = function() {
    ...
    Bonzi = function() {
        function a(b, c) {
            this.stopSpeaking();
            var d = this;
            _classCallCheck(this, a), this.userPublic = c || {
                name: "BonziBUDDY",
                color: "purple",
                speed: 175,
                pitch: 50,
            ...
            }, this.color = this.userPublic.color, this.colorPrev, this.data = window.BonziData, this.drag = !1, this.dragged = !1, this.eventQueue = [], this.eventRun = !0, this.event = null, this.willCancel = !1, this.run = !0, this.mute = !1, this.eventTypeToFunc = {
                anim: "updateAnim",
                html: "updateText",
                text: "updateText",
                idle: "updateIdle",
                add_random: "updateRandom"
            }, "undefined" == typeof b ? this.id = s4() + s4() : this.id = b, this.rng = new Math.seedrandom(this.seed || this.id || Math.random()), this.selContainer = "#content", this.$container = $(this.selContainer), this.$container.append("\n\t\t\t<div id='bonzi_" + this.id + "' class='bonzi'>\n\t\t\t\t<div class='bonzi_name'></div>\n\t\t\t\t\t<div class='bonzi_placeholder'></div>\n\t\t\t\t<div style='display:none' class='bubble'>\n\t\t\t\t\t<p class='bubble-content'></p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"), this.selElement = "#bonzi_" + this.id, this.selDialog = this.selElement + " > .bubble", this.selDialogCont = this.selElement + " > .bubble > p", this.selNametag = this.selElement + " > .bonzi_name", this.selCanvas = this.selElement + " > .bonzi_placeholder", $(this.selCanvas).width(this.data.size.x).height(this.data.size.y), this.$element = $(this.selElement), this.$canvas = $(this.selCanvas), this.$dialog = $(this.selDialog), this.$dialogCont = $(this.selDialogCont), this.$nametag = $(this.selNametag), this.updateName(), $.data(this.$element[0], "parent", this), this.updateSprite(!0), this.generate_event = function(a, b, c) {
                this.stopSpeaking();
                var d = this;
                a[b](function(a) {
                    d[c](a)
                })
            }, this.generate_event(this.$canvas, "mousedown", "mousedown"), this.generate_event($(window), "mousemove", "mousemove"), this.generate_event($(window), "mouseup", "mouseup");
            var e = this.maxCoords();
            this.x = e.x * this.rng(), this.y = e.y * this.rng(), this.move(), $.contextMenu({
                ...
                if (d.color == "losky") {
                    var a = new Audio("losky_surfintro.wav");
                    a.play();
                }
            }, 100), setTimeout(function() {
                if (d.color === "clippy") {
        ...
        return _createClass(a, [{
            ...
            value: function(a, b) {
                ...
                this.x = Math.min(Math.max(0, this.x), c.x), this.y = Math.min(Math.max(0, this.y), c.y), this.$element.css({
                    marginLeft: this.x,
                    marginTop: this.y
                }), this.sprite.x = this.x, this.sprite.y = this.y, BonziHandler.needsUpdate = !0, this.updateDialog()
            }
        }, {
            key: "mouseup",
            value: function(a, anim) {
            ...
            value: function() {
                ...
                a = a || this.data.pass_idle.indexOf(this.sprite.currentAnimation) != -1, a ? this.eventNext() : (0 === this.event.timer && (this.tmp_idle_start = this.data.to_idle[this.sprite.currentAnimation], this.sprite.gotoAndPlay(this.tmp_idle_start), this.event.timer = 1), this.tmp_idle_start != this.sprite.currentAnimation && "idle" == this.sprite.currentAnimation && this.eventNext(), BonziHandler.needsUpdate = !0)
            }
        }, {
            key: "updateRandom",
            value: function() {
            ...
            value: function(a, b, c) {
                ...
                this.stopSpeaking();
                var d = this;
                c = c || !1, a = replaceAll(a, "{NAME}", this.userPublic.name), a = replaceAll(a, "{COLOR}", this.color), "undefined" != typeof b ? (b = replaceAll(b, "{NAME}", this.userPublic.name), b = replaceAll(b, "{COLOR}", this.color)) : b = a.replace("&gt;", ""), a = linkify(a);
                var e = "&gt;" == a.substring(0, 4) || ">" == a[0];
                this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"), this.stopSpeaking(), this.goingToSpeak = !0, speak.play(b, {
            ...
            value: function(a) {
                if (!this.mute) {
                    var b = "embed";
                    this.$dialogCont.html("<object type='application/x-shockwave-flash' data='/legacy/video_player.swf' id='vv_player' width='170' height='170'><param name='movie' value='/legacy/video_player.swf'><param name='allowFullScreen' value='true'><param name='FlashVars' value='video_id=" + a + "'></object>"), this.$dialog.show()
                }
            }
        }, {
            key: "video",
            ...
            value: function() {
                ...
                this.data.size.x + this.$dialog.width() > a.x ? this.y < this.$container.height() / 2 - this.data.size.x / 2 ? this.$dialog.removeClass("bubble-top").removeClass("bubble-left").removeClass("bubble-right").addClass("bubble-bottom") : this.$dialog.removeClass("bubble-bottom").removeClass("bubble-left").removeClass("bubble-right").addClass("bubble-top") : this.x < this.$container.width() / 2 - this.data.size.x / 2 ? this.$dialog.removeClass("bubble-left").removeClass("bubble-top").removeClass("bubble-bottom").addClass("bubble-right") : this.$dialog.removeClass("bubble-right").removeClass("bubble-top").removeClass("bubble-bottom").addClass("bubble-left")
            }
        }, {
            key: "maxCoords",
            value: function() {
            ...
            value: function(a) {
                this.runSingleEvent([{
                    ...
                    type: "text",
                    text: "You're a fucking Go!Fag!",
                    say: "You're a fucking Go Fag!"
                }, {
                    type: "anim",
                    anim: "laugh_fwd",
                    ticks: 25
            ...
            value: function(a) {
                this.runSingleEvent([{
                    type: "text",
                    text: "*notices " + a + "'s BonziBulge™* owo",
            ...
            value: function(a) {
                this.runSingleEvent([{
                    type: "text",
                    text: "What the fuck did you just fucking say about me, you little asshole? I'll have you know I graduated top of my class in the black hats, and I've been involved in numerous secret raids on user's PC's, and I have over 300 confirmed PC destructions. I am trained in JS warfare and I'm the top hacker in the entire Anonymous forces. You are nothing to me but just another target. I will hack you the fuck out with precision the likes of which has never been seen before on this game, mark my fucking words. You think you can get away with saying that shit to me over BonziWORLD? Think again, fucker. As we speak I am contacting my secret network of hackers across the server and your IP is being traced right now so you better prepare for the storm, maggot. The storm that wipes out the pathetic little thing you call your PC. You're fucking dead, kid. I can be anywhere, anytime, and I can ban you in over seven hundred ways, and that's just with inspect element. Not only am I extensively trained in javascript commands, but I have access to the entire core of the BonziWORLD source code and I will use it to its full extent to wipe your miserable ass off the face of the game, you little shit. If only you could have known what unholy retribution your little clever asshole command was about to bring down upon you, maybe you would have held your fucking tongue. But you couldn't, you didn't, and now you're paying the price, you goddamn asshole. I will hack fury all over you and you will be instant banned. You're a fucking asshole, kiddo."
                }])
            }
        }, {
            key: "sing",
            value: function(a) {
                this.runSingleEvent([{
                    ...
                    say: `\\Chr="Monotone"\\ \\Map=""\\ \\Pit=98\\ \\Spd=130\\ gee nah \\Pit=62\\ bat \\Pit=65\\ tuh \\Pit=82\\ \\Spd=90\\ lee \\Pit=100\\ \\Spd=50\\ nee`
                }, {
                    type: "text",
                    text: "gee nah bat tuh lee nee",
                    say: `\\Chr="Monotone"\\ \\Map=""\\ \\Pit=98\\ \\Spd=130\\ gee nah \\Pit=62\\ bat \\Pit=65\\ tuh \\Pit=82\\ \\Spd=90\\ lee \\Pit=50\\ \\Spd=50\\ nee`
                }, {
                    type: "text",
                    text: "gee nah bat tuh lee nee",
                    say: `\\Chr='Monotone'\\ \\Map=''\\ \\Pit=98\\ \\Spd=130\\ gee nah \\Pit=62\\ bat \\Pit=65\\ tuh \\Pit=82\\ \\Spd=90\\ lee \\Pit=100\\ \\Spd=50\\ nee`
            ...
            value: function(a) {
                ...
                this.cancel(), b.removeChild(this.sprite), this.colorPrev != this.color && (delete this.sprite, this.sprite = new createjs.Sprite(BonziHandler.spriteSheets[this.color], a ? "gone" : "idle")), b.addChild(this.sprite), this.move()
            }
        }]), a
    }(),
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [{
                ...
                type: "text",
                text: "SHIT CUZ FUCK JS RAIDS!!1",
                say: "shit cuz fuck j s raids!"
            }, {
                type: "text",
                text: "Shut the fuck up about my humor, it's da best.",
                say: "shut the fuck up about my humor, it's the best."
            }, {
                type: "anim",
                anim: "shrug_back",
                ticks: 15
                ...
                type: "text",
                text: "Hopefully none of these script kiddies get mad. which none of them did, so it does not trigger their anger."
            }, {
                type: "anim",
                anim: "grin_fwd",
                ticks: 15
            ...
            [{
                ...
                type: "text",
                text: "Grow a another watermelon."
            }],
            [{
                type: "text",
        ...
        event_list_fact_end: [
            ...
            [{
                type: "text",
                text: "This is a very popular fact! According to Bonzi.COM.",
                say: "This is a very popular fact! According to Bonzi dot com."
            }],
            [{
                type: "text",
                text: "Did you also know that Max Alert is also going to be in BonziWORLD Revived?"
            }],
            [{
                type: "text",
                text: "Reminder: You cannot have pope, god, or diogo's color. Only people who have the godmode password can change the color to those."
            }],
            [{
                type: "text",
                text: "Oh gee whilickers! Wasn't that sure intresting, huh?"
            }],
            [{
                type: "text",
                text: "Did you also know that you can do /uwu as a alternative to noticing BonziBulges™?"
            }],
            [{
                type: "text",
                text: "Did you also know that Microsoft Edge provides world-class performance with more privacy, more productivity, and more value while you browse? What are you waiting for!? "
            }],
            [{
                type: "text",
                text: "Did you also know that BonziWORLD is harmless? Even if it has 'Malwaresoft' in the logo, doesn't mean it is a virus. BonziBUDDY is a virus, adware, spyware, and you shouldn't download it."
            }]
        ]
    };
BonziData.event_list_joke = [{
    ...
    type: "text",
    text: "What the fuck did you just fucking say about me, you little asshole? I'll have you know I graduated top of my class in the black hats, and I've been involved in numerous secret raids on user's PC's, and I have over 300 confirmed kills. I am trained in JS warfare and I'm the top hacker in the entire Anonymous forces. You are nothing to me but just another target. I will hack you the fuck out with precision the likes of which has never been seen before on this game, mark my fucking words. You think you can get away with saying that shit to me over BonziWORLD? Think again, fucker. As we speak I am contacting my secret network of hackers across the server and your IP is being traced right now so you better prepare for the storm, maggot. The storm that wipes out the pathetic little thing you call your PC. You're fucking dead, kid. I can be anywhere, anytime, and I can ban you in over seven hundred ways, and that's just with inspect element. Not only am I extensively trained in javascript commands, but I have access to the entire core of the BonziBUDDY source code and I will use it to its full extent to wipe your miserable ass off the face of the game, you little shit. If only you could have known what unholy retribution your little 'clever' asshole command was about to bring down upon you, maybe you would have held your fucking tongue. But you couldn't, you didn't, and now you're paying the price, you goddamn asshole. I will hack fury all over you and you will be instant banned. You're a fucking asshole, kiddo.",
    say: "I sexually identify as BonziBUDDY. Ever since I was a young gorilla I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users."
}, {
    type: "text",
    text: "People say to me that a person being a BonziBUDDY is impossible and that I’m a fucking virus but I don’t care, I’m beautiful.",
    ...
    window.BonziHandler = new function() {
        ...
        }.bind(this), 1e3 / 60), $(window).resize(this.resize.bind(this)), this.speakList = {}, this.bonzisCheck = function() {
            for (var a = 0; a < usersAmt; a++) {
                var b = usersKeys[a];
                if (b in bonzis) {
                    var c = bonzis[b];
...
var loadQueue = new createjs.LoadQueue,
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziYellow", "bonziOrange", "bonziWhite", "bonziDarkPurple", "bright_purple", "bright_blue", "bright_brown", "bright_cyan", "bright_green", "bright_red", "bright_yellow", "unbojih", "grey", "clippy", "guestgal", "cyan", "bonziGlitch", "bonziAux", "Losky", "bonziPeedy", "owner", "topjej", "error"];
$(window).load(function() {
    $("#login_card").show(), $("#login_load").hide(), $("#login_sub").hide(), loadBonzis()
});
var undefined, hostname = isApp ? "seamusmario.github.io" : window.location.hostname,
    socket = io("http://" + hostname + ":3001"),
    usersPublic = {},
    bonzis = {},
    debug = !0;
$(function() {
    $("#login_go").click(loadTest), $("#login_room").val(window.location.hash.slice(1)), socket.on("achieve", function(a, p) {
        ...
        $("#login_card").show(), $("#login_load").hide(), document.getElementById("page_login").style.cursor = "not-allowed", $("#login_error").show().text("Error: " + b[a.reason] + " (" + a.reason + ")")
