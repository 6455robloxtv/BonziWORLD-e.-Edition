...
if (!self.__WB_pmw) {
    ...
    function setup() {
        io = null, socket = null, $("#chat_send").click(sendInput), $("#chat_message").keypress((function(e) {
            ...
            } else if ("bonzi_weather" == e.room) $("#bonzi_tv").html("<div id='bonzi_tv_player' style='position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;'></div>"), theme('#content{background-image:url("/img/desktop/logo.tv.png"), url("/img/desktop/bg.png");} #bonzi_tv_yt{background-image:url("/img/desktop/logo.tv.png"), url("/img/desktop/bg.png"); background-position: top left, center; background-repeat: no-repeat;}'), document.getElementById("bonzi_tv").innerHTML = dontUseMyLocation ? '<iframe id="bonzi_tv_yt" style="position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;" src="//web.archive.org/web/20230618030736/https://weatherscan.net/?long_island" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>' : '<iframe id="bonzi_tv_yt" style="position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;" src="//web.archive.org/web/20230618030736/https://weatherscan.net/" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
        ...
        Bonzi = function() {
            ...
            return _createClass(e, [{
                ...
                value: function() {
                    ...
                    if (this.$canvas.css("background-position-x", `-${Math.floor(this.sprite.currentFrame%17)*this.data.size.x}px`), this.$canvas.css("background-position-y", `-${Math.floor(this.sprite.currentFrame/17)*this.data.size.y}px`), this.$canvas.css("filter", `hue-rotate(${this.userPublic.hue}deg)         saturate(${this.userPublic.saturation}%)         drop-shadow(20px -5px 4px rgba(0,0,0,0.2))`), this.run) {
                ...
                value: function(e, t, o) {
                    ...
                    if (this.$dialogCont[o ? "html" : "text"](o ? twemoji.parse(e) : e)[i ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"), this.stopSpeaking(), t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(/~/gi, "?")).replace(/bonzi.ga/gi, window.location.host)).replace(/bonzi.lol/gi, window.location.host)).replace(/bzw/gi, "bonziworld")).replace(/bwe/gi, "bonziworld enhanced")).replace(/bwr/gi, "bonziworld revived")).replace(/bwce/gi, "bonziworld community edition")).replace(/&amp;/gi, "and")).replace(/&num;/gi, "hash tag")).replace(/&gt;/gi, "greater than")).replace(/&lt;/gi, "less than")).replace(/&gt/gi, "greater than")).replace(/&lt/gi, "less than")).replace(/TTS/g, "text to speech")).replace(/tts/g, "text to speech")).replace(/wdym/gi, "what do you mean")).replace(/idc/gi, "i don't care")).replace(/idk/gi, "i don't know")).replace(/btw/gi, "by the way")).replace(/idfc/gi, "i don't fucking care")).replace(/idfk/gi, "i don't fucking know")).replace(/idgaf/gi, "i don't give a fuck")).replace(/wtf/gi, "what the fuck")).replace(/wth/gi, "what the hell")).replace(/kys/gi, "kill yourself")).replace(/afaik/gi, "as far as i know")).replace(/iirc/gi, "if i remember correctly")).replace(/TIL /g, "today i learned")).replace(/PST/g, "pacific standard time")).replace(/MST/g, "mountain standard time")).replace(/CST/g, "central standard time")).replace(/EST/g, "eastern standard time")).replace(/AST/g, "alantic standard time")).replace(/PDT/g, "pacific daylight time")).replace(/MDT/g, "mountain daylight time")).replace(/CDT/g, "central daylight time")).replace(/EDT/g, "eastern daylight time")).replace(/ADT/g, "alantic daylight time"), this.goingToSpeak = !0, "default" == this.userPublic.voice)
                        ...
                        n.clearDialog()
                    }) : (this.userPublic.a = new Audio("//web.archive.org/web/20230618030736/https://bonziworld.co/" + n.userPublic.voice + "?text=" + encodeURIComponent(t)), this.userPublic.a.play(), this.userPublic.a.onended = function() {
                        n.clearDialog()
                    });
                ...
                key: "letsplay3",
                value: function() {
                    this.mute || (this.$dialogCont.html('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="//web.archive.org/web/20230618030736/https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="270" height="270"><param name="wmode" value="window"><param name="movie" value="//web.archive.org/web/20230618030736/https://zone.msn.com/bingame/zum2/default/Zuma2Preloader_1_0.swf"><param name="flashvars" value=""><param name="play" value="true"><param name="bgcolor" value="#FFFFFF"><param name="base" value="/https://zone.msn.com/binGame/zum2/default"><param name="allowScriptAccess" value="always"><param name="menu" value="false"><embed id="GameObject" name="GameObject" src="/https://zone.msn.com/bingame/zum2/default/Zuma2Preloader_1_0.swf" wmode="window" base="/binGame/zum2/default" menu="false" allowscriptaccess="always" flashvars="" play="true" bgcolor="#FFFFFF" width="270" height="270" type="application/x-shockwave-flash" pluginspage="//web.archive.org/web/20230618030736/https://www.macromedia.com/go/getflashplayer" swliveconnect="true"><noembed><blockquote><font face="Lucida Console, Monaco, mono" size="-2"><A href="//web.archive.org/web/20230618030736/https://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" target="_self">This site requires Macromedia Flash to be properly installed in a capable browser.<BR> Follow this link, and you\'ll find out everything you need to know.</A></font></blockquote></noembed></object>'), this.$dialog.show())
                }
            }, {
                key: "iframe",
                value: function(e) {
...
/*
     FILE ARCHIVED ON 03:07:36 Jun 18, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:12:54 Jan 24, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 7.993
  LoadShardBlock: 248.783 (3)
  PetaboxLoader3.datanode: 127.952 (4)
  PetaboxLoader3.resolve: 193.107 (2)
  load_resource: 122.467
*/
